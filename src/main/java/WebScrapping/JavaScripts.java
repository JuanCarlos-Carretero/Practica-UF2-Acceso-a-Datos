...
/**
 * En esta clase tenemos los WebScrapping.JavaScripts que utilizamos en las demas clases. (En este caso solo uso uno)
 */
public class JavaScripts {
    /**
     * Este metodo sirve para hacer scroll en la pagina generada.
     * @param veces le decimos las veces que hay que hacer scroll.
     * @param driver le hacemos llegar la variable driver de la clase WebScrapping.WebScraping.
     * @param wait le hacemos llegar la variable wait de la clase WebScrapping.WebScraping.
